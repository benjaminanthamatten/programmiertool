...
setcookie("erstaufruf","on",time()+(3600*365));
    ...
    setcookie("width_$i","50",time()+(3600*365));
    setcookie("padding_top_$i","20",time()+(3600*365));
    setcookie("padding_bottom_$i","20",time()+(3600*365));
    setcookie("padding_left_$i","150",time()+(3600*365));
    setcookie("padding_right_$i","150",time()+(3600*365));
